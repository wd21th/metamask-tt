...
function MainPage() {
	...
	const [defaultAccount, setDefaultAccount] = React.useState<null | string>(null);
  ...
  return (
    ...
    <header className='in-row'>
      ...
      <div className="in-row half-width content-right">
          {
          defaultAccount ? <span className='primary-color'>{defaultAccount.slice(0, 15)}...</span> : <button className="wallet primary-bg slim-width secondary-color" onClick={connectWalletHandler}>
            Connect metamask
          </button>
          }
      </div>
            ...
            <div className='press user'>
              ...
              <form className="user__form" onSubmit={(e: FormEvent)=> {
                ...
                <div className="user__field">
                  ...
                  {
                    (defaultAccount && user) ?  <p className='primary-color user__form-value'>{user.username}</p> : <input className='user__form-input primary-color' type="text" placeholder='We will display your name in participation list' name='username' />
                  }
                ...
                <div className="user__field">
                  ...
                  {
                    (defaultAccount && user) ?  <p className='primary-color user__form-value'>
                      {user.email}
                ...
                <button className={"user__form-button primary-bg secondary-color"+ (listMe ? ' pale': '')} onClick={()=> {
                  if(defaultAccount && user && !listMe){
                    setListMe(true)
                  }
                }}>
                  { (defaultAccount && user) ? 'List me to the table' : 'Connect metamask'}
                </button>
              </form>
          </div>
          {
  ...
  return (
    ...
    <header className='in-row'>
      ...
      <div className="in-row half-width content-right">
       ...
       <div className="full-screen parent v-center">
        <div className="in-row info">
          <div className='press user'>
